...
export default function FashionScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      {/* Header */}
      <View style={[styles.header, { paddingTop: topPad, backgroundColor: "#EC4899" }]}>
      ...
      >
        ...
        <View style={[styles.comingSoonContainer, { paddingVertical: 80 }]}>
          <View style={[styles.iconCircle, { backgroundColor: "#EC489922" }]}>
            <Ionicons name="shirt-outline" size={64} color="#EC4899" />
          </View>
          ...
          <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>
            Explorez les dernières tendances de la mode. Vêtements, chaussures, accessoires et bijoux pour tous les styles.
          </Text>
